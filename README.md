...
Se você for apresentar o projeto em um evento, use esta opção. O Docker resolve todas as dependências de sistema (como o Chromium para acessar vagas) sem instalar lixo na sua máquina.
